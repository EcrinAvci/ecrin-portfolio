    ...
    <>
      ...
      <main style={styles.container}>
        ...
        <div style={{...styles.content, paddingTop: '100px'}}>
          <header style={styles.header}>
            ...
            <p style={styles.description}>
              Modern web teknolojileri kullanarak kullanıcı dostu ve performanslı uygulamalar geliştiriyorum. 
              React, Next.js, Node.js ve daha birçok teknoloji ile projeler üretiyorum.
            </p>
          </header>
        ...
        <div style={styles.socialLinks}>
          ...
          <a href="https://linkedin.com/in/ecrinavci" style={styles.socialLink} target="_blank" rel="noopener noreferrer">
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
